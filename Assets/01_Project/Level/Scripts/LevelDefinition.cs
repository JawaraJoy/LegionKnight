...
namespace LegionKnight
{
    ...
    public partial class LevelDefinition : ScriptableObject
    {
        ...
        private string m_Id;
        [SerializeField]
        private SceneConfig m_LevelScene;
        [SerializeField]
        ...
        [SerializeField]
        private List<PlatformConfig> m_PlatformAssets = new();
        ...
        public SceneConfig LevelScene => m_LevelScene;
        ...
        public void StartLevel()
        {
            ...
            GameManager.Instance.SceneController.LoadSceneConfig(m_LevelScene);
        ...
        public List<PlatformConfig> GetPlatformAssets()
        {
            return m_PlatformAssets;
        }
        public List<PlatformConfig> GetBosPlatformAssets()
        {
