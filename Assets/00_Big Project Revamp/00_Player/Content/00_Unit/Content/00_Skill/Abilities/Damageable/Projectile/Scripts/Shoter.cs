...
namespace Rush
{
    ...
    public class Shoter : DamageAbilityDeliver
    {
        ...
        {
            int count = m_ShotAbilityConfig.SpawningSetup.FireCount;
        ...
        public Targetable GetNewTargetForProjectile()
        {
            List<Targetable> targets = new(GetTargetsInternal());
            if (targets == null || targets.Count == 0)
                return null;

            return targets[0]; // already priority sorted
        }
        ...
        private void PreWarm()
        {
            ...
            int count = m_ShotAbilityConfig.SpawningSetup.PreWarmCount;
